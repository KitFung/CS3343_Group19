...
public class TestTicket extends TestCase{
  ...
  public void testArrange1() {
    Ticket ticket1 = new Ticket(new CustomerGroup(1, 8,new StateWaitingFood()), new DateTime());
    Ticket ticket2 = new Ticket(new CustomerGroup(1, 8,new StateWaitingFood()), new DateTime());
